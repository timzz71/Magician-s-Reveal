...
param(
    ...
    [string]$ModsPath = "",   # If not set, will try to find .minecraft\mods
    [switch]$Verbose          # Enable verbose output
)

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  MAGICIAN'S REVEAL - v2.0.0" -ForegroundColor Cyan
...
# Obfuscated patterns from grim.txt (compressed for performance)
$obfuscatedPatterns = @(
    "xP[Z", "o*-t", "o*-B", "]@QF", "<T:Lsixtwo/cB;>Lsixtwo/az;", "6cMM", "G5Jzv", "A4z@", "bu\\", "oqdd",
    "(gH:aO", "1Qjv", "Lorg/apache/commons/lang3/mutable/MutableObject<Lcom/mojang/datafixers/util/Pair<TT;Ljava/lang/Integer;>;>;", "\:PP",
    "isvgM", "\:PL", "wzbU", "?T(G", "}6==", "}k*k*", "i4EE", "F#OI", "E;UU", "}qtp",
    "v@T}T}", "EtRqE", "Q//H1", "lGtt", "(hhh(OOO(555(", "]@RR", "s_+%", "</Px</Px",
    "hD66", "DMD(", "o*..", "oqgg", "*2CC", "oqgB", "{`wA", "Y3D=gM",
    "([Lsixtwo/kZ;)Lsixtwo/la$us;", "1Qii", "1QiK", "Borg/appliedenergistics/yoga/event/YogaEvent$MeasureCallbackEndData",
    "1$fhI", "TG{U", "$@{S9S9", "n#22", "O]'*'*", "L]QQ", "D$HbeS", "USE_FOG",
    "}62H", "(^``", "}62D", "\:WD", "~E&Z>QQ", "A%22A%22", "Windows.Storage.Search.ContentIndexerQuery.GetAsync",
    ")M4ga@r", "==.>r.", "?T)I", "tTHTH", "BII11", "}qk+", ">ejej", "8s;Sv",
    "i4FF", "_jbb", "]@~$H1", "i4F{", "ofwqq", "u0D0D", "Aq+)", ")4\"G",
    "Aq+A", "]@S:", "o*//", "Ljava/util/LinkedList<Ljdk/internal/net/http/AuthenticationFilter$CacheEntry;>;",
    "71NN", "xPEE", "TGt~", "TGtt", "2r?I1I1", "o,pU1^", "A4|q", "cOqhP",
    "6cKR", "[o;;", "P+ji", "P+jH", "bu^^", "JrC46", "L]VV", "J5HP=",
    "`4~_D", "L]V;", "1QhI", ":Ce[5%e[5%", "n#3q", "IPZLPZL", "%LSISI", "\:Vp",
    "oOIzJ", "jU;;", "w15J", "F#Mu", "jU;K", "jU;C", "F#MZ", "F#MK",
    "i4GH", "}qjj", "PRe|a|a", "Z@r@r", "20260521055238.972Z0", "o*((", "71I1",
    "33^b3b", "D$Dbsj", "hhhlhh\SShF::h.\"\"h", "s_)M", "A4}V", "A4}}", "5mXvH1H1",
    "oqaK", "oqaq", "P+kb", "bu_Y", "oqaa", "6cH1", ")4#A", "bu_H",
    "5Eh@TH", "fU|WLd", "y_]_]", "TGuu", "Ljava/util/List<Lnet/minecraft/class_12036$class_12040<TV;>;>;",
    "~AI!I!", "r>:>:", "\:U*", "}60(", "&i--", "'*->j", "_l9mH1", "{#F1F1",
    "i4HH", "w144", "(^fH", "i4H1", "U@i&&", "xpH3FF", "S_&&", "|GH1",
    "!'a4a4", "o*)B", ";rRSV", "Windows.Services.TargetedContent.TargetedContentAction.InvokeAsync",
    "|GHL", "71H1", "(II)f", ")4$$", "s_(B", ";;I11", "sixtwo/bf.class",
    "6cI1", "3Ko[", "oq`.", "oq`>", "oq``", "oruoe", ";|#K", "P+dI",
    "bu@B", "{`rH", "1QV~", "vHNH1H1", "Uw&3L", "sx)A2", "!)_)_", "}qhF",
    "}qhT", "3|33L", "S_%H", "i4I1", "i4II", "|GII", "s_7j", "71KK",
    "].L.L", "CijLy", "EvbL", "71Kz", "Wgngn", "uG[3H", "xPFF", "'d0G%_",
    "Aq(B", "lGpp", "Aq(k", "_Tj.j.", "]@VV", "Pti@t@", "oqcc", "D$HbaI",
    "oqcH", "6,?~", "1QUC", "],4II", "pDI;", "pDIB", "7x/l>rKrK", "wzoo",
    "}666", "&i/w", "&i//", "bKCvM", "F#H1", "-m}Z7i>h", "jdk.internal.net.http.PlainProxyConnection",
    "71JJ", "Yfq=%Qc", "3KmA", "o*++", "s_6B", "oqbb", "6cGG",
    ...
    "{`pp", ";(Lnet/minecraft/class_1792;Ljava/util/function/Predicate;)V", "Q}SF", "Q}SI", "*ibyy",
    "sSm|I1", "J|Lw.t", "net.minecraft.class_9135", "net.minecraft.class_9139", "me3p3p",
    "pDHI", "pDHH", "pDHN", ".?AV<lambda_286>@?0??initClassRegistrars@@YAXXZ@",
    "pDHA", "[+)gg", "Lnet/minecraft/class_9139<Lnet/minecraft/class_9129;Lnet/minecraft/class_10266;>;",
    "H+s1QQ", "G.@I1", "!t**", "\:Zi", "?T\"7", "r(F<I", "Xv71u",
    "-%1G5", "F#I1", "tre_z", "i4KN", "s_5_", "wjkjk", "]@H1",
    "gkTUTU", "BH'E]", "Ev`F", "lGrC", "o*$D", "]@Hu", ")4'<",
    "DM>}", ")4''", "A4q<", "A4q1", "3Kll", "y\*\*", "6cDD",
    "oq]A", "oq]]", "P+gg", "pDKK", "{`qq", "[o6&", "wzik",
    "n#<<", "L][C", "net.minecraft.class_9106", "wzi5", "*XS[m",
    "!t++", "/ZAx+x+", "!t+F", ">u7-I-I", "S_\"E", "E;ZF",
    "i4Lw", "Hf-3I", ".jbjb", "Aq5(", "EvaA", "ns<H1",
    "XH!`XH!`", "DM?|", "Aq5C", "TwS}c", "fVCH1", "]@I1",
    "DM?M", "s_4B", "t$|Hc", "A4rr", "oq\\", "A4r!",
    ")4(B", "D$kcKH", "buDH", "buDD", "Cx\x\",
    "P+`)", "x<@m8", "[o55", "}4}}kKkk``W`uuCu",
    ";|'{", "class_9837.java", "pDJJ", "L]XX", "pH=]u",
    "}65H", "i4M$", "org.jose4j.jwt.consumer.SubValidator",
    "&rw_q", "Np4WdH1H1", "S_!8", "Aq4L", "!9C7~n",
    "DM<I", "s_3&", "o*&&", "(Lsixtwo/mG;)Lsixtwo/jR$uc;",
    "7C'j?", "xPBm", "A4sF", "Cd)H1", "`DDDDDD",
    "oq__", "oq_Z", "[o44", "NHNHT", "wzkL",
    "]L1L1", "1QQ/", "L]YY", "L]Y[", "n#:<",
    "<Mgz0F", "8jN?jjN", "mBajP", "\:_p", "\:_I",
    "}qcH", "?T!2", "&CO(mb", "i4NJ", "i4NN",
    "()Lsixtwo/hL<TT;>;", "71VI", "D$|bkG", "uU=[=[",
    "s_2S", "s_2(", "Evg)", "o*''", "Aq3X",
    "xPMM", "Aq3F", ")4*.", "rD;b0!", "o*'m",
    "EvgL", "o*'B", "lG}F", "o\^<<", "xPM1",
    "8e}SQ", "oq^~", "P+bb", "q<18f]83p", "P+b~",
    ",bjH1", "sNH11", "n#;;", "(\"w~.", "wztt",
    "?T>d", "!t..", "}6+J", "]f\H1", "jU3;",
    "F#EE", "fivefive/n$F", "w1=I", "fcJw]8Q",
    "71Qw", "lG~E", "44[w0", "Q}VV", "Q}VH",
    "Aq20", "3K`d", "r{Y3535", ")4+;", "|v^]oA",
    "oqYY", "buGR", "P+cI", "{`MM", "1Q__",
    "c?A+JoS", "net.minecraft.class_9142", "net.minecraft.class_9141",
    "6,99", "L]_{", "\&>{>{", "L]_*", "uhD;u",
    "!t/F", "~EH!'", "}qaE", "jU44", "}qaa",
    "S_..", "mixin/accessors/ItemInHandRendererAccessor",
    "_jtQ", "AZx6#", "Aq11", ")4,E", "o*!!",
    "DM3C", "`R5H1=bb", ")4,,", "6cA|", "oqXX",
    "buH1", ";|+n", "#fH#fH", ";|+K", "pDNH",
    "KC|b|b", "buHH", "{`JJ", "[o1H", "'\]H1",
    "lext-ms-win-rtcore-ntuser-dc-access-l1-1-0", "wzvD",
    "Zp'_", "n#99", "|lNlN", "gv/7L", "}6)H",
    "*t(I(I", "!$%&'+,0234579=DGMRWYZ_w", "5t}=6H1",
    "_juu", "E;!\", "}q`B", "]W}?2?2", "BA$C+EWq",
    "]@NG", "o*\"\"", "71S:", "]@Ny", "lGx&",
    "A4wF", "Q}T0", "3Kff", "6c~F", "{`KK",
    "buII", "buIH", "i~|/ZK{pK{p", "*%79jaja",
    "1Q]B", "6,7C", "buI!", "n#&x", "n#&{",
    "D$HbYu", "\:CC", "\:CE", "\:CH", "4QA}<LL",
    "wzwz", "L]]]", "T;9;9", "H5oMHMH", "R\Dk(hFbLbL",
    "jU6K", "jU6Z", "_jvC", "1CT\"bD<", "Aq?M",
    "Aq?G", "DM1I", "5p-KH1", "xPI1", "Evko",
    "PRB/$H$H", "/>`11>", "Q}[C", "Zp%L", "3Kem",
    "Zp%'", "~pcWME=831.-,+***********))))))))))))(((((((((((('''''''&&&&&%%%%%%%%%%%%%$$$$$$$$$$$$$$$$$$##########################################################################$$$$$$$$$$$$$$$$$$%%%%%%%%%%%%%%&&&'''''''''((((((((((())))))))))))***********+,-.027<AKT_lz",
    "oqZ6", "{`H1", "oqZZ", "P+~Z", "buJJ",
    "{`HJ", "{`HH", "wzpG", "L]bE", "6,6H",
    "#{EI1", "}6//", "w19H", "HjpOO", "jU7@",
    ";3mWW", "Q|7CL", "H\'e'e", "yHO$0$0", "_jww",
    "S_++", "s_=w", "]l(Ip<", "4*eHY", "Aq>W",
    "Q}Zi", "L8Stt", "xPH1", "3KdO", "buK@",
    "oqUU", "leadPerLine", "6,5H", "{`I1", "net.minecraft.class_9186",
    "net.minecraft.class_9182", "net.minecraft.class_9183", "bGQk`a", "mQ*q)",
    "]!DlDl", "?T;H", "L]cv", "njDjD", "zQc&0",
    "qH)Ti7}", "{{L{ee3eOO", "0ztfH", "?T;;", "_jpp",
    "!t#H", "(^r@", "rm+m+", "3$tP`", "[RX^Y6",
    "AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Calls.PhoneLineDialResult>", "Aq=m",
    "71\\", "%[?1PI", "L8Suu", "xPKK", "MvnmI",
    "oqTc", "DrDrDr", "oqTT", "buL1", "]QG>]QG>",
    "1QZ;", "Zp##", "6NuH1H1", "6U!U!", "L]`H",
    "AsyncOperationCompletedHandler`1<Windows.System.UserProfile.SetImageFeedResult>", "^R$Z$Z",
    ")p7NN", "w1;M", "!t$$", "}6-M", "Lnet/minecraft/class_10945;",
    "}qdd", "8\"cN[\"cN[", "&H>{l", "S_)m", "7Y[_cbb",
    "S_)H", "#`x6H", "s_;;", "DM44", "7t$F",
    "{W?W?", "$$lf`", "VnnniiTizz;z", "Q}XI", "CN8>p!",
    "Zp\"E", "oqWW", "IG*)I!", "GQ$H1H1", "pDuF",
    "buMM", "q%]-{-{", "wzsL", "6,33", "1QYY",
    "1(-:77", "}6\"M", "}6\"D", "}6\"\"", "H>}H1",
    "NVlH1", "(^p+", "`A`2`'`", "]klp\\", "!t%J",
    "!t%d", "!t%a", "!_dc00f6c4e711701456d12cffea74b22b", "_jrr",
    "]4YH1H1", "fc.Z", "E;$H", "DM55", "]@CX",
    "i6mz3", "Q}_L", "Q}_I", "DM5T", "3Kyy",
    "s_:J", "oqVV", "onPlaneMapUnmasked", "0~cIcI",
    "oqV7", "6,2f", "-.<_ejh@keke", "1QXF", "n##M",
    "cuQBK", "6,22", "keJL1", "pDtF", "67uPg",
    "\:FJ", "5VRF", "wz||", "L]fH", "L]fC",
    "aaa5aaaNaahhah", "JU=6", "5VR|", "JU=*", "jU+A",
    "_jss", "w1E3", "(^wG", "MGquj", "jU++",
    "vH3Wyy", "DM*H", "]@D8", "[eQ(tUHUH", "DM**",
    "fc/L", "S(;glw", "r5znqL", "H3Q##", ")Y&I1",
    "oqQC", "oqQU", "{`EE", "6,11", "5VSY",
    "w1DI", "hvvv^iiiSYYYEHHH6666%%\"%", "\:EE", "Q#9#9",
    "e,%De,%D%D", "?T7I", "JcJGd", "F#ZF", "_jLL",
    "fc,F", "71XX", "+hTCQ", "Evmm", "xPww",
    "lGG[", "`:`2`'`2`\"`2`", "DM+A", "DM+H", "ZOff",
    "!\"J/H", "oqPC", "}}}-|||Fzzz`yyyywyy", "Zp/8", "1QFF",
    "AsyncOperationCompletedHandler`1<Windows.ApplicationModel.Chat.ChatMessage>", "A['7a/",
    "n#!!", "Zp/K", "5VPP", "6,0!", "q|M`v",
    "pDvH", "\:DA", "L]d+", "wz~~", "L]dd",
    "}6!!", "z{``5LL", "[ZZrZXX^XUUJUQQ7QJJ#JCC", "(MLmH",
    "F#[L", "w1GD", "NjnBI", "_jM1", "zqlLH1",
    "O*t]@H1", "JcJH1", "E;))", "EvrL", "xPvv",
    "Q}\\", "e&gnH", "_?;A@~@~", "D$DbaJ", "&qZ2v",
    "EIJyJQ", "oqSS", "ZC\"C\"", "1QEE", "YMqbu",
    "1QEH", "D$zo/ocf", "L]eB", ">?~,J:", "JU0H",
    "}6&F", "}6&I", "?T5G", "?T5I", "D$|bgn",
    "F#X#", "vC7=N", "71ZF", "71ZZ", "DM)l",
    "7t!H", "P?-?-", "Q}CC", "3K}}", "3K}C",
    "Fi<nhe!I", "Eh#Gu", "6cww", "oqRR", "6cwF",
    "rritii_Z__TATTH'HH:", "{`@r", "P+vH", "{`@@", "{`@]",
    "5VVC", "5VVQ", "1QDD", "JU1H", "00c209e2H",
    "9\"R<P", "rz=j8CUzI", "\:JA", "-xW5W5", "~Tle^e^",
    "tIRhJ", "jU/L", "!hQ*g", "arEEw", "fc+v",
    "^.=0n", "]@8A", "Df&H1", "DM.*", "Q}BB",
    "ui1Bp", "qb\2\2", "D$Dbgb", "xPp*", "oqMM",
    "z2{L{L", "EL2mH", "oru|&", "eg/FH/FH", "..(*#",
    "1QCC", "n#,L", "oO}A/p-", "5VW2", "hMRH1H1",
    "oX%^3[oX%^3[%^3[%^3[", "\:IF", "\:I1", "o6rd~d~",
    "}6$V", "?T33", "(Lnet/minecraft/class_1799;Ljava/util/List;)I", "org/jose4j/jwk/OctetKeyPairJsonWebKey",
    "_jH1", "E;*J", "~<MLI", "ACx&V", "S_22",
    "x$@+\\", "(pL11", "71dI", "lGCL", "lGCH",
    "LD#/+]", "(Lnet/minecraft/class_12205$class_12314;Lnet/minecraft/class_4543;)V", "dMYY",
    "H3qbDD", "PVdNe", "^Ue0I", "oqLL", "Windows.Storage.PathIO.ReadTextWithEncodingAsync",
    "C\C!m!m", "([Lnet/fabricmc/fabric/api/client/event/lifecycle/v1/ClientWorldEvents$AfterClientWorldChange;)V",
    "6,,,", "^HlE`x", "{`^^", ",!!r:", "pDzh",
    "wzzI", "5VT&", "wzzz", "<#\HO", "\:H!",
    "\:H1", "!t<<", "}6%%", "up:p:", "\:HH",
    "-7?7?", "0lRH1H1", "?T0O", "_jI1", "zNhNh",
    "_jII", "_jIH", "fc)P", "YGtpp", "\"H3hR$$",
    ".$I1I1", "PQq~H1", "rW}$H1", "D$DbeT", "EvvL",
    "DM,A", "EvvA", "ZUNUN", "]@:K", "DM,L",
    "uv)I1", "6crO", "3Krr", "}6dzSH", "..@-A@@:T@@@g@@@z@@@",
    "3KrI", ":r+RJH", "1QAS", "W9E6U", "5VU{",
    "5VU_", "pD}L", "7ob!&", "?T1a", "jU\"\"",
    "K{HHH", "F#TT", "hFGxx", "_jJ%", "fc&I",
    "3g<g<", "Evww", "RUaT", "lGMM", "Q}GD",
    ".|7Q", "_bIbI", ",GAA8", "ZO``", "{`\E",
    "\''\"\AA9\ZZM\s\Z\\", "h=]>L", "Zp))", "reduce_water_ambient_spawns",
    "|{QL1", ":wno9", "FcQPH", "Kptqx", ">#$s",
    "\"W]W]", "!t>C", "s^lhss", "!t>J", "_1Wi[",
    "JU5K", "sixtwo/ng.class", "o-\"PJ", "F#UJ", "F#UU",
    "E;/S", ".|66", "ZOaa", "fc'K", "RUbb",
    "xP|A", "=/a0z+", ")(FFFFFLsixtwo/mG;FLsixtwo/mG;)Lsixtwo/id;", "Zp(H",
    "D$DbkP", "oqI1", "(%BkI1", "oqI!", "oqII",
    "B9p6R]", "{`]D", "Windows.ApplicationModel.Store.Preview.InstallControl.AppInstallManager.StartAppInstallWithTelemetryAsync",
    "5V[I", "A'9HH", "{<RU]m", "JU6E", "i(%ji(%j",
    "PGZ1El", "M.J.J", "|=66", "o-\"SY", "aU]aH",
    "%j@U=!", "jU$$", "(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/util/concurrent/CompletableFuture;",
    "F#RL", "S_>>", "grIH1", "xW:||", "fc$d",
    "RUcI", "D$|byc", "'[:|=q", "JzC!}", "(:;HH",
    "P-OSr", "H3Q**", "^uhuh", "I)LjV", "oqHH",
    "oqHx", "fs-Th7", "Zp77", "Hd#'<HH", "oqH1",
    "Xal6&H1", "h;7NU_#", "9mxs&", "1QN)", "n#))",
    "L]l/", "D$HbJe", "v[wBI", "(MH3hh", "|=7F",
    "px]x]", "JU77", "\"/#L#L", "CetK", "LJ#\"\"",
    "_jEE", "9~o0&", "(H{mqmq", ".|4y", "h\PVu",
    "]@>B", "ZOoL", "ZOoo", "RUd6", "lGH1",
    "EvzL", "Nt<t<", "u^AI1I1", "7t((", "Evzu",
    "xP~F", "6cnI", "oqKD", "oqKK", "P+MW",
    "F\"G!H!H", "{`[[", "L]mI", "R_I_I", "L]mm",
    "1QMM", "6,'B", "CewL", "JU(H", "5VYY",
    "jE'HH", "5VYC", "+5H1H1", "<A\R~8", "casuj48bimqguzbng82otwc74jqgwtyh7c49hul1e985o6yx6ssh3884jvs9jknjry2l30ouyb10yb9zyj1pchn3vwxxln0jcm8b",
    "JU((", "a0>6F", "o-\"UT", "`nn~I1", ",$E$E",
    "WICMapGuidToShortName", ".|3b", "E;00", ".|3I", "71bQ",
    "lGI1", "ZOlr", "DM!!", "lGI!", "Hy@TM",
    "QGvHH", "RUeM", "]@?E", "DM!F", "lGII",
    "xPy4", "s0]9]9", "7t))", "m\L1L1", "8D8B",
    "oqJJ", "6,&s", "Zp5D", "C<(s{N>", "GGG}GGGdGGELGG;33G*",
    "L]rL", "sHNv%", "?%oVV", "grNE-$t", "!t22",
    "w1I!", "w1I1", "n`d>d>", "_jGM", "F#QQ",
    "_jGy", "gy@B7y@B7y", "_jG6", "E;33", "fc#I",
    "fc##", "RUff", "71mW", "Evxx", "71mC",
    "lGJJ", "DM&A", "lGJA", "RUfK", "RUfH",
    "RUfL", "]@00", "3KtF", "W_1.#", "|e#wjp",
    "$5g81x'J8J8", "oz:?xcU#", "6clD", "oqEE", "9P6$.",
    "(H/I1I1", "P+O@", "_v^v^", "{`YI", "bu;J",
    "bu;*", "GAKK3", "1QKf", "7t6J", "6,%I",
    "o'Urr", "\v&O)44", "5V_c", "1Cr1>{", "JU*u",
    "w1HD", "3xi9H", "|=:$", "jF&F&", "!t33",
    "JU*J", "w1H1", "w1H,", "1C_=mL", "!1*-s",
    "S_:H", "u0](@@", "ZOjj", "ZOjv", "Q}I1",
    "RUgH", "8D:J", "8D:8", "Q}II", "D$DbnN",
    "6cmm", ">2e<H", "P+H1", "oqDG", "oqDD",
    "5V\H", "b\O\O", "5V\\", "Cepv", "Cepp",
    "L]p=", "*Eg(0", "CepE", "@C8nw", ">fe{",
    "|=;;", "\:pm", "'`L1L1", "NSpBuWpBuW", "!t44",
    "o-\"V.", ">#./", "S_9]", "w1K}", "_jAH",
    "$mI1I1", "[.[n[.[n", "r3EHH", "lGTC", ".|00",
    "H3+Rpp", "4u)TH", "H3Q55", "Q}H1", "6cjC",
    "oqGG", "9Mb%m_j", "dMVV", "Ej8F)K", "6cja",
    "ZOk_", "P+IT", "{`WL", "3d3d3", "P+I1",
    "1QII", "5V]u", "5V]]", "5V]>", "aHIaHI",
    "pDeJ", "\:ww", "L]qq", ">fdE", "!t5D",
    "L]qP", ">#/F", "!t5J", "9?~84", "dC,c%%",
    "v~/~/", "w1JJ", "ye+EH", "zwBcz", "E;44",
    ".|??", "ZIUst", "S_8H", "DM%L", "2HI<M5z",
    "P\kF%F%", ".|?_", "s8)8)", "Ad>d>", "N{{{hhfh",
    "Uo&44", "xPeG", "xPee", ";6X35I", "dMWL",
    ">fgg", "L]vv", "1QH1", "1QHH", "5VBw",
    "JU-C", "G+P6_.P5", ",Q:H1", ">#,A", "WebRuntime.Extensions.BrowsingExtension.PostIsolatedMessageAsync",
    "o-\"Xb", "oldbb", "o-\"X&", "o-\"X$", "xKlJc",
    "<M:ad", "}+%Mhj", "?fD98t", "71ii", "fc?-",
    "fc??", "RUj\\", "3KH1", "Ev|I", "7t2T",
    "dMTK", "class_243;Lsixtwo/ou;Lsixtwo/mw;(Lsixtwo/ot;Lsixtwo/mw;Lsixtwo/gclass_1657;Lsixt43;F)Lnet/minecr_49c1b9baee51c40be53ef034ca671f5_66e465280dfe8cff83ce4ffa5c2a248e822856f94e7f10d_c1c347717e11df0dbcd871156222b44_f5ab03348f0563c9dc451f469b5faa3_519ee5493ccc946bddd7f2b4a91db05_eb06ce8ce82096d6e901c9c954df3c9_ef880767e57308b2e2bbb6f48771263hasVisibleChips",
    "o&cCC", "dMTd", "(%\MI", "HLT6~Q", "{`UU",
    "{`Uh", "kNNYk", "lastPopulateStamp", "5VCb", "6,!b",
    "1Q7e", "\@NINI", "&9&99R&RRl&ll", "L]wI", "L]wH",
    "\:um", "Ce}?", "!t77", "o-\"[G", "JU.B",
    "JU.P", "w1Tm", "!t7S", "S_FL", "e{Dz",
    "H5rvvPH", "fc<<", "(Lsixtwo/kl$ug;)V", "0]Dff", "Ljava/util/List<Lsixtwo/nd;>;",
    "Ev}H", "xPgg", "H32{GG", "Q}MM", ".|=f",
    "6ciF", "oq@@", "Q4LH1", "7t3E", "1$fO{",
    "x<@Ih", "L$4A0", "pDff", "%1)1)", ">#*H",
    ">#*6", ">#*7", "\:tL", "\:tH", "U(gVv#y",
    "|sq%I", "9s2s%", ".?AV<lambda_148>@?0??initClassRegistrars@@YAXXZ@", "1~(Ja",
    "_j]>", "?xj+j+", "_j]D", ".|<L", "_j]]",
    ".wAHAH", "fc=n", "c(Lnet/caffeinemc/mods/sodium/client/render/chunk/vertex/format/ChunkVertexEncoder$Vertex;FFFIFFFI)V",
    "NSNfNSNf", "..&\"&&$$!$%%", "Q}L1", "yu,OH1", "71kF",
    "lGPJ", "ZOw>", "@+(TE", "dMJ0", "xPfH",
    "xPfF", "H3Q11", "Wal;Y;Y", "Zp>>", "6cfH",
    "LLLFLLLXXLXmmLm", "7Sl$g", "D$HbAy", "oqCC", "pDii",
    "1Q5\"", "P+EE", "1Q50", "bu!L", "bu!V",
    "5VA0", "EGH1GH1", "|=<q", "dkteR", "kiV,fH",
    "=U{_L", "U9BH1", "DN&'F", ">#+J", "w1VA",
    "LD9-U", "E;88", "w1Vd", "9QLy`0", "e{FF",
    "lGQQ", "Q}s^", "dMKK", "1a)!H", "oqBw",
    "=@6I1", "1Q4K", "8D0\\", "5VF\\", "5VF<",
    "@+]p", "g;$&$&", "pDhV", "02J(.`N`N", "|===",
    "gH=6II", "d'H1H1", "r(F\5", ".|:3", ".|::",
    "TQ{H%H%", ".?AV?$_Func_impl_no_alloc@V<lambda_419>@?0??initClassRegistrars@@YAXXZ@XPEAUJNIEnv_@@PEAV_jclass@@@std@@",
    "IQl]AI", "]@((", "e{I1", "e{II", "e{IM",
    "RUnC", "7t>!", "dMH1", "@+(VH", "pDkL",
    "pDkk", "^H\"jU[", "[?EcUk", "[kz^!I", "s40VNHH",
    "5VGw", ">#))", "w1PP", "vvv|vuvccavIIHv00/v", "o-\"_E",
    "$/CfH", "Qh>h>", "|0w/85c", "uI*uI*I*", "-!suL1",
    "(|AI1", "_jXn", "S_BW", "m,-,-,-", "e{HH",
    "e{HL", "ZOrr", "Q}qI", "e{H1", "Q}q|",
    "umb|N", "EvAB", "7t?M", "7t?A", "<fWmWm",
    "dMIZ", "#HhHH", "E#tsL$`", "P+@W", "bu$$",
    "dMI1", "8D2)", "6,\\", "-<gNU", "Zp;;",
    "{`..", "bu$G", "nativeRef", "1Q2H", "|=##",
    "!T!!5T55JTJHTT_STTtTTT", ">fmm", "o-\"^v", ">#6(",
    "wM`6!", "J(Ljava/lang/String;)Lnet/minecraft/class_6880<Lnet/minecraft/class_1887;>;",
    "fqqqL", "@@@|@@@h@@@U@@@A@:..@,", "bYI}KqT", "Db`;d+", "j88A%UU",
    "fc9A", "fc9+", "XeAU=", "e{KK", "EvFK",
    "RUp^", "EvFF", "Q}pp", ".|8C", ".7G(j",
    "6cbb", "3KB;", "redirect$cfa000$useIsolatedHandBufferSource", "p|$pDfD",
    "p|$pDfA", "(Lsixtwo/bB;)I", "(Lsixtwo/bB;)F", "oZO&&", "{`//",
    "7t<A", "XvzSl", "J4i3Jx", "pDmW", ">fl9",
    ";,!,!", "w1RI", "LEKhj", "E!R!R",
    "\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"",
    "3L333LIICLL^LLLsLLL", "G?$S3", "_jZZ", "startUseItemPost(Lorg/spongepowered/asm/mixin/injection/callback/CallbackInfo;)V",
    "wjkGG", ".|''", "fc6J", "RUq;", "ZOps",
    "ZOpG", "71vS", "RUqK", "0@n@n", "Zp9V",
    "6cck", "(IIIII)Lsixtwo/ie;", ">foo", "5VJJ", "SWw0eH",
    ">fo<", "Cezz", "o+H11", ">0SO}", "JU%%",
    "n3<C=", "wX.pu!~:7", "\:~X", "o-\"@_", "q^Oja.",
    "rtATN", "fc7|", "71qA", "e{MM", ".|&&",
    "?`1`-", "e{M9", ".|&D", "Nprwr", "Q}vu",
    "M$?,M$?,", "]@,h", "B599", "]@,F", "lVe==",
    "6c`K", "dMLD", "7t:8", "7t::", "DJkdN",
    "{`-G", "Zp88", "bu';", "{`--", "?*MH",
    "5VKB", "@+Zo", "@]EeH", "\:}}", ">fnn",
    "pDoo", ";bLbL", "shape/liquid", "f$u$u", "CeeR",
    "U@00", "^3RfT", "U@0Y", "&.uW|", "-XUXU",
    "oWW}}", ",X#x#x", "}tWI1I1", "wtP1#", ".|%M",
    "e{L1", "q8dxd", "RP!+a", "lG_E", "lG_I",
    "lG_H", "B5::", "oHa,,", "RUss", "Q}uH",
    "3KGG", "dMME", "dMMM", "dMMI", "p/>rI",
    "rXb^],", "dMMm", "{`*?", "K^t:H", "55H\"55a/55{455",
    "lmUnm", "5VH9", "5VH2", "6,XG", "5VHn",
    "5VH~", "5VHH", "|='H", "o-\"Bc", "ENV,$",
    "+Y+#EYE:^YYMxYYY", "6LhD4~", "'ZqW", "QhA<D", "_jUU",
    "_jUI", "iMkZ", "Tmhzd", "S_MA", "iMkk",
    "71ss", "Q}tC", "`yrz|", "lGXX", "EvJJ",
    "3KF(", "D$}Hs", "dMBB", "H3Q99", "bu))",
    "hhhzhhh``hYGGhB--h*", "bu)x", "6,WH", "6,WL",
    "6,WC", "5VIC", "5VI!", "#1;}y1;}y", "5VI1",
    "\:cI", ">fhL", "CegE", "Cegg", "o-\"E1",
    "NG(LI1", "_jVL", "RKeFeF", "T1L1L", "_jV\\",
    "w1^^", "ZNH11", "(Ljava/util/Set;)Lsixtwo/cz;", "iMjI", "fc22",
    "e{NI", "d0jDL", "RUu\\", "xPii", "xPiB",
    "B5<D", "xPi,", "]@//", "dMCC", "ZO|I",
    "rWzJz", "bu*J", "bu*F", "?*Hk", "e(8u%Lv",
    "^/(ebeb", "?*H1", "Or$3L", "&,/A", ">fkk",
    "Ceff", "o(Mgg", "w1YC", "U@3!", "!_9e47ba1c6c79b2bfe0db7421cc17e628",
    "AsyncOperationCompletedHandler`1<Windows.Foundation.Uri>", "\:bI", "iMii", "1ymym", "iMiM",
    "_jW9", "CCTHH", "KHquH", "fc33", "XII2IK;KKe,ee~",
    "[$Q$H1", "EvH1", "B5==", "e{QQ", "71}H",
    "EvHH", "RUvC", "GJ=~N?", "7tFF", "8D+E",
    "Q}zz", "7^OI1", "Q}zE", "8D++", "11WJ~]",
    "?*I1", "}2]!,", "?H.?H.", "6,U2", "5VON",
    ">fjF", "5VOe", "xINNc", "!.A!.A", ".bITI,",
    "&,.e", "\:as", "~c_H1", "X&sH", "X&sq",
    "Rq,q,", "+TMHnTMHn", "requireType", "71|K", "]@!!",
    "@p$|H", "7tGm", "QnWH1", "B5>j", "FE@[T",
    "5Rc4HH", "sourceEntity;affectedState", "ZOzn", "6SeT6SeT", "P+X;",
    "6,TT", "5Jc5Jc", "1Q:J", "y,/NI", "{`&&",
    "5VLc", "?*JZ", "x?*?*", "5VL1", "rkEkE",
    "X&r2", "|=++", "O<hH1", "ax|F`Ly", "@~\oH",
    "S-;bS-;b", "fe;4G", "'Z}f", "'Z}}", "|QOfOf",
    "S_II", "S_IM", "S_IQ", "]@\"\"", "DQ`\\d",
    "B5?G", "%{]{]", "B5??", "UUQH!", "UUQH)",
    "||$|bb$bII$I//$/$", "?*KK", "o&cqq", "aMmGHH",
    "P+YA", "P+Yy", "b\OMu", ">ft3", "X&qq",
    "X&qF", "cuQaH", "X&qK", "^xIHH", "ko77",
    "5VMM", "|=((, "+j1t5", "+3h6h6", ">#?I",
...
# Combine all patterns for file content matching
...
function Scan-FileSystem {
    ...
    # We'll use a simpler approach: combine patterns with '|' but limit length to avoid regex overflow.
    # Since the list is huge, we'll process in chunks of 100 patterns.
    $chunkSize = 100
...
function Scan-Registry {
    ...
    # (Keep existing registry scanning)
...
$report += "`n============================================"
$report += "`nReport generated by Magician's Reveal v2.0.0"
$report += "`n============================================"
