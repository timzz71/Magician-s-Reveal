# ============================================================
#  MAGICIAN'S REVEAL  v3.0
#  Professional Minecraft Forensic Scanner
#  Clean detection • No random false positives
# ============================================================
...
Write-Host "  MAGICIAN'S REVEAL - v3.0" -ForegroundColor Cyan
...
# ---------- 3. Known cheat indicators (curated – no random noise) ----------
$cheatStrings = @(
    # Combat / macros
...
Write-Host ""
Write-Host "  Scan complete – Magician's Reveal v3.0" -ForegroundColor Cyan
Write-Host ""
